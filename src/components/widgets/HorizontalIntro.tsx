...
export default function HorizontalIntro() {
  return (
    <div className="p-custom">
      <div className="flex flex-col md:flex-row items-stretch justify-between bg-light text-dark p-6 md:p-8 gap-6 md:gap-8 max-w-6xl mx-auto">
        {/* Left - Quote */}
        ...
        {/* Right - Description */}
        <div className="md:w-1/2 text-sm md:text-base leading-relaxed space-y-4">
          <p>
